...
If (OK=1)
	...
	While (Not:C34(End selection:C36([Role:3])))
		...
		$texte:=$texte+String:C10([Role:3]CreatDate:7)+$tab
		$texte:=$texte+String:C10([Role:3]CreatHeure:8)+$tab
		$texte:=$texte+String:C10([Role:3]ModifDate:9)+$tab
		$texte:=$texte+String:C10([Role:3]ModifHeure:10)+$tab
		$texte:=$texte+$rc
